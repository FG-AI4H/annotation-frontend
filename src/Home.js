            ...
            <div>
                ...
                <Container maxWidth="xl" sx={{ mt: 5 }}>
                    <div className="mui-row">
                        <div className="mui-col-md-12"><h1 className="header">Welcome To The FG-AI4H Platform</h1></div>
                    </div>
                    <div className="mui-row">
                        <div className="mui-col-md-12"><h5>Welcome To The FG-AI4H Platform</h5></div>
                    </div>
