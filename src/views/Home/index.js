              ...
              <Card sx={{ height: 1 }}>
                ...
                <CardContent>
                  ...
                  <Typography variant='body2' color='text.secondary'>
                    Provides safe and secure storage of medical data; serves as
                    an interface to access this data; and offers data governance
                    that complies with data protection laws. Medical data
                    storage requires adherence to strict guidelines that
                    preserve the privacy and safety of patients. The Data
              ...
              <Card sx={{ height: 1 }}>
                ...
                <CardContent>
                  ...
                  <Typography variant='body2' color='text.secondary'>
                    ...
                    intensive. Certain features must be considered when
                    evaluating an annotation: the quality of labels, the number
                    of expert opinions, and the handling of non-unanimous
                    decisions. This Annotation Platform brings together leading
                    health experts across the globe to produce the
                    highest-quality annotations at maximum efficiency.
                  </Typography>
                </CardContent>
                <CardActions>
                  <Button
