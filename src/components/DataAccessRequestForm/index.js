...
const DataAccessRequestForm = (props) => {
  ...
  function updateRequest(newStatus) {
    Auth.currentAuthenticatedUser({
      ...
      .then((currentUser) => {
        ...
        client
          .updateDataAccessRequestStatus(formState.id, newStatus)
          .then((_response) => {});
      })
          ...
          {readOnlyMode && (
            <>
              ...
              {formState.request_status === 'APPROVED' && (
                <Button variant='contained' color='info' onClick={deprecate}>
                  Deprecate
                </Button>
              )}
            </>
