    ...
    <Backdrop open={isLoading} sx={{ color: '#fff', zIndex: (theme) => theme.zIndex.drawer + 1 }}>
        <CircularProgress color="inherit" />
                    ...
                    <AccordionDetails>
                        <div style={{width: '100%'}}>
                            <Grid container spacing={1}>
                                ...
                                <Grid item xs={12}>
                                    <TextField fullWidth label={"Data Registry URL"} id="component-filled27"
                                               value={formState.metadata?.data_registry_url}
                                               onChange={event => setInputMetadata('data_registry_url', event.target.value)}
                                               disabled={readOnlyMode} InputLabelProps={{shrink: true}}/>
                                </Grid>
                                <Grid item xs={6}>
                                    <TextField fullWidth label={"Data Sample Size"} required id="component-filled5"
                                               value={formState.metadata?.data_sample_size}
                                               onChange={event => setInputMetadata('data_sample_size', event.target.value)}
                                               disabled={readOnlyMode} InputLabelProps={{shrink: true}}/>
                                </Grid>
                                <Grid item xs={6}>
                                    <TextField fullWidth label={"Data Type"} required id="component-filled6"
                                               value={formState.metadata?.data_type}
                                               onChange={event => setInputMetadata('data_type', event.target.value)}
                                               disabled={readOnlyMode} InputLabelProps={{shrink: true}}/>
                                </Grid>
                                <Grid item xs={12}>
                                    <TextField fullWidth label={"Data Update Version"} id="component-filled7"
                                               value={formState.metadata?.data_update_version}
                                               onChange={event => setInputMetadata('data_update_version', event.target.value)}
                                               disabled={readOnlyMode} InputLabelProps={{shrink: true}}/>
                                </Grid>
                ...
                {formState.linked &&
                    <>
                        <TextField fullWidth margin={"normal"}
                                   ...
                                   InputLabelProps={{ shrink: true }}
                                   onChange={event => setInput('catalog_location', event.target.value)}
                        />
                        <FormControl fullWidth margin={"normal"}>
                            ...
                            <Select
                                ...
                                InputLabelProps={{ shrink: true }}
                                onChange={event => setInput('catalog_auth_type', event.target.value)}
                            >
                        ...
                        <TextField fullWidth margin={"normal"}
                                   ...
                                   sx={{ display: formState.catalog_auth_type === 'username_password' ? 'block': 'none' }}
                                   InputLabelProps={{ shrink: true }}
                        />
                        ...
                        <TextField fullWidth margin={"normal"}
                                   ...
                                   sx={{ display: formState.catalog_auth_type === 'token' ? 'block': 'none' }}
                                   InputLabelProps={{ shrink: true }}
                        />
            ...
            <Stack direction="row" spacing={2} sx={{ mt: 5 }}>
                {!readOnlyMode &&
                    <>
                <Button variant="contained" onClick={handleDataset}>{params.id === 'new' || params.id === 'link' ? 'Add' : 'Update'}</Button>
